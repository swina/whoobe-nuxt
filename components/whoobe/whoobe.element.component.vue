...
export default {
    ...
    components: {
        MokaText: ()=> import ( './elements/moka.text' ),
        MokaVideo: ()=> import ( './elements/moka.video' ),
        MokaImg: ()=> import ( './elements/moka.img' ),
        //MokaText,
        //MokaVideo,
        MokaAudio,
        MokaIframe,
    ...
    computed:{
        ...
        component(){
            ...
            if ( el.type === 'plugin' ){
                return () =>  import(/* webpackChunkName: 'whoobe_' */ '~/components/plugins/' + el.plugin.component.path)
            }
        }
    },
    methods: {
