<template>
    <div>
        <div v-if="$attrs.exclusive" class="fixed top-0 left-0 bg-opacity-75 z-1 h-screen w-screen"></div>
...
export default {
    ...
    computed:{
        ...
        color(){
            return this.$attrs.color ? ' ' + this.$attrs.color : ' bg-white text-gray-800'
        },
        confirm(){
